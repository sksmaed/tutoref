...
function CategoryCard({ item, onSelect }: { item: PopularCategoryItem; onSelect?: (item: PopularCategoryItem) => void }) {
  ...
  return (
    <button
      type="button"
      className="w-[180px] h-[56px] flex items-center justify-between rounded-lg px-5 py-4 bg-white shadow-[2px_2px_10px_0px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-px active:translate-y-0"
